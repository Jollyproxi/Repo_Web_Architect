...
function App() {
  ...
  // useState è un hook che mi permette di gestire lo stato all'interno di un componente funzionale. 
  // In questo caso, sto creando una variabile di stato chiamata "count" e una funzione "setCount" per aggiornarla. Il valore iniziale di "count" è 0.
